...
import { Alert, Box, Button, Container, Stack, TextField, ThemeProvider, createTheme, styled as styledMUI } from "@mui/material";
...
export const ChangePassword: React.FC = () => {
    ...
    const [changePasswordCompleteModalIsOpen,setChangePasswordCompleteModalIsOpen]=useState(false);
